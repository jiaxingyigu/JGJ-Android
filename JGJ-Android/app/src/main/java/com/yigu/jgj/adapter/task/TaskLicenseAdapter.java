 ...
 */
public class TaskLicenseAdapter extends RecyclerView.Adapter<TaskLicenseAdapter.ViewHolder> {
    private LayoutInflater mLayoutInflater;
    List<MapiItemResult> mList;
    private RecyOnItemClickListener onItemClickListener;
    public TaskLicenseAdapter(Context context, List<MapiItemResult> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.shopname.setText("检查店名："+taskResult.getNAME());
    }
