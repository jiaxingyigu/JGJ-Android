 ...
 */
public class FilterPop extends PopupWindow implements PopupWindow.OnDismissListener {
    ...
    public FilterPop(Activity context, List<MapiResourceResult> list) {
    ...
    class PopAdapter extends RecyclerView.Adapter<PopAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ViewHolder(inflater.inflate(R.layout.item_pop_filter,parent,false));
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if(pos==position){
                holder.text.setTextColor(Color.parseColor("#0390d0"));
                holder.item_root.setBackgroundColor(Color.parseColor("#eeeeee"));
            }else{
                holder.text.setTextColor(Color.parseColor("#333333"));
                holder.item_root.setBackgroundColor(Color.parseColor("#ffffff"));
            }
        }
