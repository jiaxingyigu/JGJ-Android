package com.yigu.jgj.activity.notify;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_right:
                ...
                showLoading();
                DailyApi.addMessage(this, userSP.getUserBean().getUSER_ID(), content.getText().toString(), idBuffer.toString()
                        , new RequestCallback() {
                            @Override
