package com.yigu.jgj.adapter.warning;
...
public class WarningAdapter extends RecyclerView.Adapter<WarningAdapter.ViewHolder>{
    ...
    public WarningAdapter(Context context, List<MapiMsgResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_warning_list, parent, false));
    }
